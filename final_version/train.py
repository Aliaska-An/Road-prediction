...
def work(x_data, y_data):
    ...
    model2 = KNeighborsRegressor(n_neighbors=4, algorithm='ball_tree',
...
def work_KNN(x_data, y_data):
    ...
    model = KNeighborsRegressor(n_neighbors=27, algorithm='ball_tree')
...
def work_network(x_data, y_data):
    test_size = 0.2
    train_x, test_x, train_y, test_y = train_test_split(x_data, y_data, test_size=0.2,
                                                        random_state=42)
    print("test size:", test_size)
